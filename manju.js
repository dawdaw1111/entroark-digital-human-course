const courseGroups=[
  ...
  {
    name:'影视实战与成长',range:'17—20',lessons:[
      {number:17,module:'影视级创作',title:'案例带练1：影视级AIGC内容创作与Skill工作流',content:'影视级AIGC内容与普通AI视频的区别；导演意图、叙事节奏、美术统一、镜头逻辑、表演连续性、声音设计和交付规格；认识Skill的作用、输入输出和调用方式；使用Skill完成剧本分析、资产提取、分镜设计、关键帧提示词、视频提示词和成片检查',practice:'Skill下载安装、使用流程以及对应工作流，全自动落地剧本、分镜、资产等',output:'专业影视级Skill工作流'},
      {number:18,module:'综合带练',title:'案例带练2：影视级AIGC影片手把手带练',content:'使用第17课形成的制作方案，完整演示制作过程；重点处理人物一致性、场景连续性、景别变化、动作衔接、运镜节奏、音乐卡点和生成失败返修',practice:'使用讲师准备的剧本、角色和场景素材包，跟随讲师逐步完成一段20—30秒影视级AIGC影片；学生同步操作，出现问题时现场诊断和修复',output:'20—30秒影视级AIGC影片＋完整项目工程文件'},
      {number:19,module:'交付规范',title:'商单交付标准详解',content:'商单需求与制作任务书的读取；成片时长、比例、分辨率、帧率和文件格式；角色与品牌一致性；字幕、音乐、字体和素材版权检查；初稿、修改稿和终稿的版本管理；反馈记录、工程归档、素材命名和交付文件夹结构；常见退稿原因',practice:'根据模拟客户需求检查一份存在问题的项目，找出规格、画面、声音、版权、命名和文件缺失问题，并整理标准交付包',output:'《动漫商单交付检查表》与标准项目交付包'},
      {number:20,module:'职业成长',title:'职业成长与作品打磨方向',content:'AI漫剧制作中的剧本、分镜、视觉资产、动态制作、声音、剪辑和项目统筹等能力方向；个人优势定位；练习作品与作品集作品的区别；作品筛选、封面、简介、制作流程和持续学习与作品迭代路径',practice:'学生选择1—2个课程作品进行诊断，重新整理作品封面、项目介绍、制作流程、个人职责和修改方向，制定后续作品打磨计划',output:'个人作品集初版＋《作品改进清单》＋阶段成长计划'}
    ]
  }
];
